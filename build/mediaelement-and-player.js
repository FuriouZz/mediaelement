...
'class="mejs-shim"></embed>';
            ...
            case 'youtube':
                ...
                var source = $(htmlMediaElement).find('source[type="video/youtube"]').get(0);
                var options = {
                    controls:   typeof $(source).data('controls')   != "undefined" ? $(source).data('controls')   : 0,
                    autohide:   typeof $(source).data('autohide')   != "undefined" ? $(source).data('autohide')   : 0,
                    showinfo:   typeof $(source).data('showinfo')   != "undefined" ? $(source).data('showinfo')   : 1,
                    showsearch: typeof $(source).data('showsearch') != "undefined" ? $(source).data('showsearch') : 1,
                    autoplay:   typeof $(source).data('autoplay')   != "undefined" ? $(source).data('autoplay')   : 0,
                    rel:        typeof $(source).data('rel')        != "undefined" ? $(source).data('rel')        : 0
                };
                youtubeSettings = {
                        container: container,
